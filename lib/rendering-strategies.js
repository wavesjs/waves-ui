...
var renderingStrategies = {
  ...
  canvas: {
    ...
    draw: function(data) {var this$0 = this;
  ...
  svg: {
    ...
    draw: function(data) {var this$0 = this;
      ...
      this.area = d3.svg.area()
        ...
        .x(function(d, i)  { return currentX; })
        .y0(function(d, i)  { return i % 2 === 0 ? _y(data[i]) : _y(data[i - 1]); })
        .y1(function(d, i)  { return i % 2 === 0 ? _y(data[i + 1]) : _y(data[i]); });

      // this doesn't work still the same memory leak problem
      var color = this.color();
      var pathStr = this.area(data);

      // this.path[0][0].setAttribute('d', pathStr);
